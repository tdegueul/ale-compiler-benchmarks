 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagram.impl.BooleanUnaryExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link activitydiagram.impl.BooleanUnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanUnaryExpressionImpl extends BooleanExpressionImpl implements BooleanUnaryExpression {
	...
	public <T> T accept(ActivityDiagramVisitor<T> visitor) {
		return visitor.visitBooleanUnaryExpression(this);
	}
