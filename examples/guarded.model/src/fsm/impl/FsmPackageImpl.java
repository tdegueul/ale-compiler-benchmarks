...
import guarded.impl.GuardedPackageImpl;
...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	...
	public static FsmPackage init() {
		...
		GuardedPackageImpl theGuardedPackage = (GuardedPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(GuardedPackage.eNS_URI) instanceof GuardedPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(GuardedPackage.eNS_URI) : GuardedPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getTransition_Tgt(), this.getState(), null, "tgt", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
