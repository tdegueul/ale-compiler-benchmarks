 ...
 * </p>
 * <ul>
 *   <li>{@link tfsm.impl.TimedTransitionImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimedTransitionImpl extends TransitionImpl implements TimedTransition {
	...
	public void setTime(long newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TIMED_TRANSITION__TIME, oldTime, time));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TfsmPackage.TIMED_TRANSITION__TIME:
				return getTime();
		}
