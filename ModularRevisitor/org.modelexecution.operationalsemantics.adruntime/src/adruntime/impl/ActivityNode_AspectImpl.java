...
import activitydiagram.impl.ActivityNodeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link adruntime.impl.ActivityNode_AspectImpl#getHeldTokens <em>Held Tokens</em>}</li>
 *   <li>{@link adruntime.impl.ActivityNode_AspectImpl#isRunning <em>Running</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityNode_AspectImpl extends ActivityNodeImpl implements ActivityNode_Aspect {
	...
	protected EClass eStaticClass() {
		return AdruntimePackage.Literals.ACTIVITY_NODE_ASPECT;
	}
	...
	public EList<Token> getHeldTokens() {
		if (heldTokens == null) {
			heldTokens = new EObjectContainmentEList<Token>(Token.class, this, AdruntimePackage.ACTIVITY_NODE_ASPECT__HELD_TOKENS);
		}
		return heldTokens;
	}
	...
	public void setRunning(boolean newRunning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdruntimePackage.ACTIVITY_NODE_ASPECT__RUNNING, oldRunning, running));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AdruntimePackage.ACTIVITY_NODE_ASPECT__HELD_TOKENS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdruntimePackage.ACTIVITY_NODE_ASPECT__RUNNING:
				return isRunning();
		}
