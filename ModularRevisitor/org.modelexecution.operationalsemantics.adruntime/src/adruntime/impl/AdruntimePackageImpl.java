...
public class AdruntimePackageImpl extends EPackageImpl implements AdruntimePackage {
	...
	public void initializePackageContents() {
		...
		booleanUnaryExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getBooleanUnaryExpression());
		booleanUnaryExpression_AspectEClass.getESuperTypes().add(this.getBooleanExpression_Aspect());
		joinNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getJoinNode());
		joinNode_AspectEClass.getESuperTypes().add(this.getControlNode_Aspect());
		booleanExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getBooleanExpression());
		opaqueAction_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getOpaqueAction());
		opaqueAction_AspectEClass.getESuperTypes().add(this.getAction_Aspect());
		initialNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getInitialNode());
		initialNode_AspectEClass.getESuperTypes().add(this.getControlNode_Aspect());
		controlNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getControlNode());
		controlNode_AspectEClass.getESuperTypes().add(this.getActivityNode_Aspect());
		executableNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getExecutableNode());
		executableNode_AspectEClass.getESuperTypes().add(this.getActivityNode_Aspect());
		activity_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getActivity());
		action_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getAction());
		action_AspectEClass.getESuperTypes().add(this.getExecutableNode_Aspect());
		integerComparisonExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getIntegerComparisonExpression());
		integerComparisonExpression_AspectEClass.getESuperTypes().add(this.getIntegerExpression_Aspect());
		activityNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getActivityNode());
		booleanBinaryExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getBooleanBinaryExpression());
		booleanBinaryExpression_AspectEClass.getESuperTypes().add(this.getBooleanExpression_Aspect());
		controlFlow_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getControlFlow());
		controlFlow_AspectEClass.getESuperTypes().add(this.getActivityEdge_Aspect());
		variable_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getVariable());
		activityFinalNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getActivityFinalNode());
		activityFinalNode_AspectEClass.getESuperTypes().add(this.getFinalNode_Aspect());
		integerCalculationExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getIntegerCalculationExpression());
		integerCalculationExpression_AspectEClass.getESuperTypes().add(this.getIntegerExpression_Aspect());
		integerExpression_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getIntegerExpression());
		integerVariable_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getIntegerVariable());
		...
		booleanVariable_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getBooleanVariable());
		booleanVariable_AspectEClass.getESuperTypes().add(this.getVariable_Aspect());
		activityEdge_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getActivityEdge());
		forkNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getForkNode());
		forkNode_AspectEClass.getESuperTypes().add(this.getControlNode_Aspect());
		finalNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getFinalNode());
		finalNode_AspectEClass.getESuperTypes().add(this.getControlNode_Aspect());
		decisionNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getDecisionNode());
		...
		mergeNode_AspectEClass.getESuperTypes().add(theActivitydiagramPackage.getMergeNode());
		...
		initEReference(getToken_Holder(), theActivitydiagramPackage.getActivityNode(), null, "holder", null, 0, 1, Token.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getVariable_Aspect_CurrentValue(), theActivitydiagramPackage.getValue(), null, "currentValue", null, 0, 1, Variable_Aspect.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInputValue_Value(), theActivitydiagramPackage.getValue(), null, "value", null, 1, 1, InputValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInputValue_Variable(), theActivitydiagramPackage.getVariable(), null, "variable", null, 1, 1, InputValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
