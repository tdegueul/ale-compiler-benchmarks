 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.InputImpl#getInputValues <em>Input Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends EObjectImpl implements Input {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.INPUT;
	}
	...
	public EList<InputValue> getInputValues() {
		if (inputValues == null) {
			inputValues = new EObjectContainmentEList<InputValue>(InputValue.class, this, ModularrevisitorPackage.INPUT__INPUT_VALUES);
		}
		return inputValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModularrevisitorPackage.INPUT__INPUT_VALUES:
