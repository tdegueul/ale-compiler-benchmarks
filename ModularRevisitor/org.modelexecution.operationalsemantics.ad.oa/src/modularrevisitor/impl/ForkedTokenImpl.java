 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.ForkedTokenImpl#getBaseToken <em>Base Token</em>}</li>
 *   <li>{@link modularrevisitor.impl.ForkedTokenImpl#getRemainingOffersCount <em>Remaining Offers Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkedTokenImpl extends TokenImpl implements ForkedToken {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.FORKED_TOKEN;
	}
		...
		if (baseToken != null && baseToken.eIsProxy()) {
			...
			if (baseToken != oldBaseToken) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModularrevisitorPackage.FORKED_TOKEN__BASE_TOKEN, oldBaseToken, baseToken));
			}
		}
		return baseToken;
	}
	...
	public void setBaseToken(Token newBaseToken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularrevisitorPackage.FORKED_TOKEN__BASE_TOKEN, oldBaseToken, baseToken));
	}
	...
	public void setRemainingOffersCount(int newRemainingOffersCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularrevisitorPackage.FORKED_TOKEN__REMAINING_OFFERS_COUNT, oldRemainingOffersCount, remainingOffersCount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModularrevisitorPackage.FORKED_TOKEN__BASE_TOKEN:
				if (resolve) return getBaseToken();
				return basicGetBaseToken();
			case ModularrevisitorPackage.FORKED_TOKEN__REMAINING_OFFERS_COUNT:
