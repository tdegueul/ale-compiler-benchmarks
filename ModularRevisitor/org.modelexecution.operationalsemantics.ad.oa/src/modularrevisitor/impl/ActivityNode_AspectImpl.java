...
import admodular.impl.ActivityNodeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.ActivityNode_AspectImpl#getHeldTokens <em>Held Tokens</em>}</li>
 *   <li>{@link modularrevisitor.impl.ActivityNode_AspectImpl#isRunning <em>Running</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityNode_AspectImpl extends ActivityNodeImpl implements ActivityNode_Aspect {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.ACTIVITY_NODE_ASPECT;
	}
	...
	public EList<Token> getHeldTokens() {
		if (heldTokens == null) {
			heldTokens = new EObjectContainmentEList<Token>(Token.class, this, ModularrevisitorPackage.ACTIVITY_NODE_ASPECT__HELD_TOKENS);
		}
		return heldTokens;
	}
	...
	public void setRunning(boolean newRunning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularrevisitorPackage.ACTIVITY_NODE_ASPECT__RUNNING, oldRunning, running));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModularrevisitorPackage.ACTIVITY_NODE_ASPECT__HELD_TOKENS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModularrevisitorPackage.ACTIVITY_NODE_ASPECT__RUNNING:
				return isRunning();
		}
