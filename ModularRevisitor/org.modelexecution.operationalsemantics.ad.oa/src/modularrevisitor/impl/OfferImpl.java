 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.OfferImpl#getOfferedTokens <em>Offered Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OfferImpl extends EObjectImpl implements Offer {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.OFFER;
	}
	...
	public EList<Token> getOfferedTokens() {
		if (offeredTokens == null) {
			offeredTokens = new EObjectResolvingEList<Token>(Token.class, this, ModularrevisitorPackage.OFFER__OFFERED_TOKENS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModularrevisitorPackage.OFFER__OFFERED_TOKENS:
