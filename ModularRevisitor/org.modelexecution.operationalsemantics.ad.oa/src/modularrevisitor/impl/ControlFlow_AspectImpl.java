 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.ControlFlow_AspectImpl#getOffers <em>Offers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlFlow_AspectImpl extends ControlFlowImpl implements ControlFlow_Aspect {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.CONTROL_FLOW_ASPECT;
	}
	...
	public EList<Offer> getOffers() {
		if (offers == null) {
			offers = new EObjectContainmentEList<Offer>(Offer.class, this, ModularrevisitorPackage.CONTROL_FLOW_ASPECT__OFFERS);
		}
		return offers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModularrevisitorPackage.CONTROL_FLOW_ASPECT__OFFERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActivityEdge_Aspect.class) {
			switch (derivedFeatureID) {
				case ModularrevisitorPackage.CONTROL_FLOW_ASPECT__OFFERS: return ModularrevisitorPackage.ACTIVITY_EDGE_ASPECT__OFFERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActivityEdge_Aspect.class) {
			switch (baseFeatureID) {
				case ModularrevisitorPackage.ACTIVITY_EDGE_ASPECT__OFFERS: return ModularrevisitorPackage.CONTROL_FLOW_ASPECT__OFFERS;
				default: return -1;
			}
		}
