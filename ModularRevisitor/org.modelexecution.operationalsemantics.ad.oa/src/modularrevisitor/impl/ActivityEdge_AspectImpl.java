...
import admodular.impl.ActivityEdgeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.impl.ActivityEdge_AspectImpl#getOffers <em>Offers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityEdge_AspectImpl extends ActivityEdgeImpl implements ActivityEdge_Aspect {
	...
	protected EClass eStaticClass() {
		return ModularrevisitorPackage.Literals.ACTIVITY_EDGE_ASPECT;
	}
	...
	public EList<Offer> getOffers() {
		if (offers == null) {
			offers = new EObjectContainmentEList<Offer>(Offer.class, this, ModularrevisitorPackage.ACTIVITY_EDGE_ASPECT__OFFERS);
		}
		return offers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModularrevisitorPackage.ACTIVITY_EDGE_ASPECT__OFFERS:
