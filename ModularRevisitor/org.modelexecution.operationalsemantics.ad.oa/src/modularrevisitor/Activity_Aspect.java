 ...
 * </p>
 * <ul>
 *   <li>{@link modularrevisitor.Activity_Aspect#getTrace <em>Trace</em>}</li>
 * </ul>
 *
 * @see modularrevisitor.ModularrevisitorPackage#getActivity_Aspect()
 * @model
 * @generated
 */
public interface Activity_Aspect extends Activity {
	 ...
	 * @see #setTrace(Trace)
	 * @see modularrevisitor.ModularrevisitorPackage#getActivity_Aspect_Trace()
	...
	/**
	 * Sets the value of the '{@link modularrevisitor.Activity_Aspect#getTrace <em>Trace</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
