...
public class ActivitydiagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ActivitydiagramPackage.BOOLEAN_UNARY_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.JOIN_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.BOOLEAN_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.OPAQUE_ACTION_ASPECT: {
			...
			case ActivitydiagramPackage.INITIAL_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.CONTROL_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.EXECUTABLE_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.ACTIVITY_ASPECT: {
			...
			case ActivitydiagramPackage.ACTION_ASPECT: {
			...
			case ActivitydiagramPackage.INTEGER_COMPARISON_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.ACTIVITY_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.BOOLEAN_BINARY_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.CONTROL_FLOW_ASPECT: {
			...
			case ActivitydiagramPackage.VARIABLE_ASPECT: {
			...
			case ActivitydiagramPackage.ACTIVITY_FINAL_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.INTEGER_CALCULATION_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.INTEGER_EXPRESSION_ASPECT: {
			...
			case ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT: {
			...
			case ActivitydiagramPackage.BOOLEAN_VARIABLE_ASPECT: {
			...
			case ActivitydiagramPackage.ACTIVITY_EDGE_ASPECT: {
			...
			case ActivitydiagramPackage.FORK_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.FINAL_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.DECISION_NODE_ASPECT: {
			...
			case ActivitydiagramPackage.MERGE_NODE_ASPECT: {
