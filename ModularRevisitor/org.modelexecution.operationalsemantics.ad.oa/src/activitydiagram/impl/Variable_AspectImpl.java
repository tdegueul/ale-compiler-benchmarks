...
import activitydiagramoa.impl.VariableImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagram.impl.Variable_AspectImpl#getCurrentValue <em>Current Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Variable_AspectImpl extends VariableImpl implements Variable_Aspect {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.Literals.VARIABLE_ASPECT;
	}
		...
		if (currentValue != null && currentValue.eIsProxy()) {
			...
			if (currentValue != oldCurrentValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramPackage.VARIABLE_ASPECT__CURRENT_VALUE, oldCurrentValue, currentValue));
			}
		}
		return currentValue;
	}
	...
	public void setCurrentValue(Value newCurrentValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.VARIABLE_ASPECT__CURRENT_VALUE, oldCurrentValue, currentValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramPackage.VARIABLE_ASPECT__CURRENT_VALUE:
