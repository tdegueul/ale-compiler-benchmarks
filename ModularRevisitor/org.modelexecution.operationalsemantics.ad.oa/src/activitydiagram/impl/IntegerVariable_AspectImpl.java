 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagram.impl.IntegerVariable_AspectImpl#getCurrentValue <em>Current Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerVariable_AspectImpl extends IntegerVariableImpl implements IntegerVariable_Aspect {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.Literals.INTEGER_VARIABLE_ASPECT;
	}
		...
		if (currentValue != null && currentValue.eIsProxy()) {
			...
			if (currentValue != oldCurrentValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT__CURRENT_VALUE, oldCurrentValue, currentValue));
			}
		}
		return currentValue;
	}
	...
	public void setCurrentValue(Value newCurrentValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT__CURRENT_VALUE, oldCurrentValue, currentValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT__CURRENT_VALUE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Variable_Aspect.class) {
			switch (derivedFeatureID) {
				case ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT__CURRENT_VALUE: return ActivitydiagramPackage.VARIABLE_ASPECT__CURRENT_VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Variable_Aspect.class) {
			switch (baseFeatureID) {
				case ActivitydiagramPackage.VARIABLE_ASPECT__CURRENT_VALUE: return ActivitydiagramPackage.INTEGER_VARIABLE_ASPECT__CURRENT_VALUE;
				default: return -1;
			}
		}
