...
public class Activitydiagramoa$defaultBooleanValueOperationImpl implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultBooleanValueOperation { 
	...
	private final activitydiagramoa.BooleanValue self;
	
	public Activitydiagramoa$defaultBooleanValueOperationImpl(final activitydiagramoa.BooleanValue self, Object algebra) {
		this.self = self;
	}
