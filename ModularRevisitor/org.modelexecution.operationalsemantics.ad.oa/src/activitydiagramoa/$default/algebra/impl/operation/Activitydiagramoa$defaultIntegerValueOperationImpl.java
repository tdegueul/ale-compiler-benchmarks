...
public class Activitydiagramoa$defaultIntegerValueOperationImpl implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultIntegerValueOperation { 
	...
	private final activitydiagramoa.IntegerValue self;
	
	public Activitydiagramoa$defaultIntegerValueOperationImpl(final activitydiagramoa.IntegerValue self, Object algebra) {
		this.self = self;
	}
