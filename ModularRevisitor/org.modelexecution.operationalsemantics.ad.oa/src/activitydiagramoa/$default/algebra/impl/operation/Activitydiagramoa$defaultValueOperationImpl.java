...
public class Activitydiagramoa$defaultValueOperationImpl implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultValueOperation { 
	...
	private final activitydiagramoa.Value self;
	
	public Activitydiagramoa$defaultValueOperationImpl(final activitydiagramoa.Value self, Object algebra) {
		this.self = self;
	}
