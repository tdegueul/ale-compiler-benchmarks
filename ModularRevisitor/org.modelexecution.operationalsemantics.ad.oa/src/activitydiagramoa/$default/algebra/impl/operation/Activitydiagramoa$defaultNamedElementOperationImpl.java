...
public class Activitydiagramoa$defaultNamedElementOperationImpl implements activitydiagramoa.$default.algebra.operation.Activitydiagramoa$defaultNamedElementOperation { 
	...
	public Activitydiagramoa$defaultNamedElementOperationImpl(final activitydiagramoa.NamedElement self, Object algebra) {
		this.self = self;
	}
