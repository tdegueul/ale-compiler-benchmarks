package admodular.$default.algebra.impl.operation;
public class Admodular$defaultBooleanValueOperationImpl implements admodular.$default.algebra.operation.Admodular$defaultBooleanValueOperation { 
	...
	private final admodular.BooleanValue self;
	
	public Admodular$defaultBooleanValueOperationImpl(final admodular.BooleanValue self, Object algebra) {
		this.self = self;
	}
