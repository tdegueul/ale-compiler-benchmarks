...
public class Admodular$defaultIntegerValueOperationImpl implements admodular.$default.algebra.operation.Admodular$defaultIntegerValueOperation { 
	...
	private final admodular.IntegerValue self;
	
	public Admodular$defaultIntegerValueOperationImpl(final admodular.IntegerValue self, Object algebra) {
		this.self = self;
	}
