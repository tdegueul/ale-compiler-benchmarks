...
public class Admodular$defaultValueOperationImpl implements admodular.$default.algebra.operation.Admodular$defaultValueOperation { 
	...
	private final admodular.Value self;
	
	public Admodular$defaultValueOperationImpl(final admodular.Value self, Object algebra) {
		this.self = self;
	}
