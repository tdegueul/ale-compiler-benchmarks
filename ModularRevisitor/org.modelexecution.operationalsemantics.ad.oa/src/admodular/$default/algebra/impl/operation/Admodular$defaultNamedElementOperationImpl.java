...
public class Admodular$defaultNamedElementOperationImpl implements admodular.$default.algebra.operation.Admodular$defaultNamedElementOperation { 
	...
	private final admodular.NamedElement self;
	
	public Admodular$defaultNamedElementOperationImpl(final admodular.NamedElement self, Object algebra) {
		this.self = self;
	}
