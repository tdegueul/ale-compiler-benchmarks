 ...
 * </p>
 * <ul>
 *   <li>{@link admodular.impl.BooleanExpressionImpl#getAssignee <em>Assignee</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BooleanExpressionImpl extends ExpressionImpl implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return AdmodularPackage.Literals.BOOLEAN_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdmodularPackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(BooleanVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmodularPackage.BOOLEAN_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmodularPackage.BOOLEAN_EXPRESSION__ASSIGNEE:
