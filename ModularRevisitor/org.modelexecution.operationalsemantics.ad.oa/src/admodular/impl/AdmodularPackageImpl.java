...
import admodular.AdmodularFactory;
...
import admodular.BooleanUnaryOperator;
...
import admodular.IntegerCalculationOperator;
import admodular.IntegerComparisonExpression;
import admodular.IntegerComparisonOperator;
...
import modularrevisitor.impl.ModularrevisitorPackageImpl;
 ...
 * @generated
 */
public class AdmodularPackageImpl extends EPackageImpl implements AdmodularPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see admodular.AdmodularPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AdmodularPackageImpl() {
		super(eNS_URI, AdmodularFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AdmodularPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AdmodularPackage init() {
		if (isInited) return (AdmodularPackage)EPackage.Registry.INSTANCE.getEPackage(AdmodularPackage.eNS_URI);

		// Obtain or create and register package
		AdmodularPackageImpl theAdmodularPackage = (AdmodularPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AdmodularPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AdmodularPackageImpl());
		...
		theAdmodularPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AdmodularPackage.eNS_URI, theAdmodularPackage);
		return theAdmodularPackage;
	}
	 ...
	 * @generated
	 */
	public AdmodularFactory getAdmodularFactory() {
		return (AdmodularFactory)getEFactoryInstance();
	}
