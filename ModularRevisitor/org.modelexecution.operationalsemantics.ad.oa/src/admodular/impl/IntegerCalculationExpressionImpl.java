...
public class IntegerCalculationExpressionImpl extends IntegerExpressionImpl implements IntegerCalculationExpression {
	...
	protected EClass eStaticClass() {
		return AdmodularPackage.Literals.INTEGER_CALCULATION_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdmodularPackage.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(IntegerVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmodularPackage.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public void setOperator(IntegerCalculationOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmodularPackage.INTEGER_CALCULATION_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmodularPackage.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE:
				if (resolve) return getAssignee();
				return basicGetAssignee();
			case AdmodularPackage.INTEGER_CALCULATION_EXPRESSION__OPERATOR:
				return getOperator();
		}
