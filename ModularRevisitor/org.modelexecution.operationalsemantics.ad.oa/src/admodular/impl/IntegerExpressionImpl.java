...
public abstract class IntegerExpressionImpl extends ExpressionImpl implements IntegerExpression {
	...
	protected EClass eStaticClass() {
		return AdmodularPackage.Literals.INTEGER_EXPRESSION;
	}
		...
		if (operand2 != null && operand2.eIsProxy()) {
			...
			if (operand2 != oldOperand2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdmodularPackage.INTEGER_EXPRESSION__OPERAND2, oldOperand2, operand2));
			}
		}
		return operand2;
	}
	...
	public void setOperand2(IntegerVariable newOperand2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmodularPackage.INTEGER_EXPRESSION__OPERAND2, oldOperand2, operand2));
	}
	...
	public IntegerVariable getOperand1() {
		if (operand1 != null && operand1.eIsProxy()) {
			...
			if (operand1 != oldOperand1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdmodularPackage.INTEGER_EXPRESSION__OPERAND1, oldOperand1, operand1));
			}
		}
		return operand1;
	}
	...
	public void setOperand1(IntegerVariable newOperand1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdmodularPackage.INTEGER_EXPRESSION__OPERAND1, oldOperand1, operand1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdmodularPackage.INTEGER_EXPRESSION__OPERAND2:
				if (resolve) return getOperand2();
				return basicGetOperand2();
			case AdmodularPackage.INTEGER_EXPRESSION__OPERAND1:
