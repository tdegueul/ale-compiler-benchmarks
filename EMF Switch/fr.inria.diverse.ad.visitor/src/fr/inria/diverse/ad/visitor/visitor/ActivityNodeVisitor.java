...
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.ActivityFinalNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.DecisionNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.ForkNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.InitialNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.JoinNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.MergeNodeActivityNodeOperationImpl;
import fr.inria.diverse.ad.visitor.impl.operation.executable.activitynode.OpageActionActivityNodeOperationImpl;
