package fr.inria.diverse.ad.visitor.benchmark;
...
//		final ActivityVisitor visitor = new ActivityVisitor();

		final long start = System.currentTimeMillis();
//		visitor.doSwitch(activity).main(inputValues);
		final long stop = System.currentTimeMillis();

		return stop - start;
	}
	//
	// private long executeActivity(String modelPath, int limit, Map<Integer,
	// Integer> map) {
