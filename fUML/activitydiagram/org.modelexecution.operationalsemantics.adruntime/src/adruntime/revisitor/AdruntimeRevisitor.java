...
Adwithoutruntime__ExecutableNodeT executableNode_action_Aspect(final adruntime.Action_Aspect action_Aspect);
Adwithoutruntime__NamedElementT namedElement_action_Aspect(final adruntime.Action_Aspect action_Aspect);
Adruntime__ExecutableNode_AspectT executableNode_Aspect_action_Aspect(final adruntime.Action_Aspect action_Aspect);
Adwithoutruntime__ActionT action_action_Aspect(final adruntime.Action_Aspect action_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_action_Aspect(final adruntime.Action_Aspect action_Aspect);
...
Adwithoutruntime__ActivityEdgeT activityEdge_activityEdge_Aspect(final adruntime.ActivityEdge_Aspect activityEdge_Aspect);
Adwithoutruntime__NamedElementT namedElement_activityEdge_Aspect(final adruntime.ActivityEdge_Aspect activityEdge_Aspect);
...
Adwithoutruntime__ActivityFinalNodeT activityFinalNode_activityFinalNode_Aspect(final adruntime.ActivityFinalNode_Aspect activityFinalNode_Aspect);
Adwithoutruntime__ControlNodeT controlNode_activityFinalNode_Aspect(final adruntime.ActivityFinalNode_Aspect activityFinalNode_Aspect);
...
Adwithoutruntime__FinalNodeT finalNode_activityFinalNode_Aspect(final adruntime.ActivityFinalNode_Aspect activityFinalNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_activityFinalNode_Aspect(final adruntime.ActivityFinalNode_Aspect activityFinalNode_Aspect);
...
Adwithoutruntime__ActivityNodeT activityNode_activityFinalNode_Aspect(final adruntime.ActivityFinalNode_Aspect activityFinalNode_Aspect);
...
Adwithoutruntime__NamedElementT namedElement_activityNode_Aspect(final adruntime.ActivityNode_Aspect activityNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_activityNode_Aspect(final adruntime.ActivityNode_Aspect activityNode_Aspect);

Adruntime__Activity_AspectT activity_Aspect(final adruntime.Activity_Aspect activity_Aspect);
Adwithoutruntime__ActivityT activity_activity_Aspect(final adruntime.Activity_Aspect activity_Aspect);
Adwithoutruntime__NamedElementT namedElement_activity_Aspect(final adruntime.Activity_Aspect activity_Aspect);
...
Adwithoutruntime__ExpressionT expression_booleanBinaryExpression_Aspect(final adruntime.BooleanBinaryExpression_Aspect booleanBinaryExpression_Aspect);
Adwithoutruntime__BooleanBinaryExpressionT booleanBinaryExpression_booleanBinaryExpression_Aspect(final adruntime.BooleanBinaryExpression_Aspect booleanBinaryExpression_Aspect);
...
Adwithoutruntime__BooleanExpressionT booleanExpression_booleanBinaryExpression_Aspect(final adruntime.BooleanBinaryExpression_Aspect booleanBinaryExpression_Aspect);
...
Adwithoutruntime__ExpressionT expression_booleanExpression_Aspect(final adruntime.BooleanExpression_Aspect booleanExpression_Aspect);
Adwithoutruntime__BooleanExpressionT booleanExpression_booleanExpression_Aspect(final adruntime.BooleanExpression_Aspect booleanExpression_Aspect);
...
Adwithoutruntime__ExpressionT expression_booleanUnaryExpression_Aspect(final adruntime.BooleanUnaryExpression_Aspect booleanUnaryExpression_Aspect);
...
Adwithoutruntime__BooleanUnaryExpressionT booleanUnaryExpression_booleanUnaryExpression_Aspect(final adruntime.BooleanUnaryExpression_Aspect booleanUnaryExpression_Aspect);
Adwithoutruntime__BooleanExpressionT booleanExpression_booleanUnaryExpression_Aspect(final adruntime.BooleanUnaryExpression_Aspect booleanUnaryExpression_Aspect);

Adruntime__BooleanVariable_AspectT booleanVariable_Aspect(final adruntime.BooleanVariable_Aspect booleanVariable_Aspect);
Adwithoutruntime__VariableT variable_booleanVariable_Aspect(final adruntime.BooleanVariable_Aspect booleanVariable_Aspect);
Adwithoutruntime__BooleanVariableT booleanVariable_booleanVariable_Aspect(final adruntime.BooleanVariable_Aspect booleanVariable_Aspect);
...
Adwithoutruntime__ActivityEdgeT activityEdge_controlFlow_Aspect(final adruntime.ControlFlow_Aspect controlFlow_Aspect);
...
Adwithoutruntime__NamedElementT namedElement_controlFlow_Aspect(final adruntime.ControlFlow_Aspect controlFlow_Aspect);
Adwithoutruntime__ControlFlowT controlFlow_controlFlow_Aspect(final adruntime.ControlFlow_Aspect controlFlow_Aspect);

Adruntime__ControlNode_AspectT controlNode_Aspect(final adruntime.ControlNode_Aspect controlNode_Aspect);
Adwithoutruntime__ControlNodeT controlNode_controlNode_Aspect(final adruntime.ControlNode_Aspect controlNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_controlNode_Aspect(final adruntime.ControlNode_Aspect controlNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_controlNode_Aspect(final adruntime.ControlNode_Aspect controlNode_Aspect);
...
Adwithoutruntime__ControlNodeT controlNode_decisionNode_Aspect(final adruntime.DecisionNode_Aspect decisionNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_decisionNode_Aspect(final adruntime.DecisionNode_Aspect decisionNode_Aspect);
Adwithoutruntime__DecisionNodeT decisionNode_decisionNode_Aspect(final adruntime.DecisionNode_Aspect decisionNode_Aspect);
...
Adwithoutruntime__ActivityNodeT activityNode_decisionNode_Aspect(final adruntime.DecisionNode_Aspect decisionNode_Aspect);
...
Adwithoutruntime__ExecutableNodeT executableNode_executableNode_Aspect(final adruntime.ExecutableNode_Aspect executableNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_executableNode_Aspect(final adruntime.ExecutableNode_Aspect executableNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_executableNode_Aspect(final adruntime.ExecutableNode_Aspect executableNode_Aspect);
...
Adwithoutruntime__ControlNodeT controlNode_finalNode_Aspect(final adruntime.FinalNode_Aspect finalNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_finalNode_Aspect(final adruntime.FinalNode_Aspect finalNode_Aspect);
Adwithoutruntime__FinalNodeT finalNode_finalNode_Aspect(final adruntime.FinalNode_Aspect finalNode_Aspect);
Adruntime__ControlNode_AspectT controlNode_Aspect_finalNode_Aspect(final adruntime.FinalNode_Aspect finalNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_finalNode_Aspect(final adruntime.FinalNode_Aspect finalNode_Aspect);
...
Adwithoutruntime__ControlNodeT controlNode_forkNode_Aspect(final adruntime.ForkNode_Aspect forkNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_forkNode_Aspect(final adruntime.ForkNode_Aspect forkNode_Aspect);
Adwithoutruntime__ForkNodeT forkNode_forkNode_Aspect(final adruntime.ForkNode_Aspect forkNode_Aspect);
Adruntime__ControlNode_AspectT controlNode_Aspect_forkNode_Aspect(final adruntime.ForkNode_Aspect forkNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_forkNode_Aspect(final adruntime.ForkNode_Aspect forkNode_Aspect);
...
Adwithoutruntime__ControlNodeT controlNode_initialNode_Aspect(final adruntime.InitialNode_Aspect initialNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_initialNode_Aspect(final adruntime.InitialNode_Aspect initialNode_Aspect);
Adwithoutruntime__InitialNodeT initialNode_initialNode_Aspect(final adruntime.InitialNode_Aspect initialNode_Aspect);
...
Adwithoutruntime__ActivityNodeT activityNode_initialNode_Aspect(final adruntime.InitialNode_Aspect initialNode_Aspect);
...
Adwithoutruntime__IntegerCalculationExpressionT integerCalculationExpression_integerCalculationExpression_Aspect(final adruntime.IntegerCalculationExpression_Aspect integerCalculationExpression_Aspect);
Adwithoutruntime__ExpressionT expression_integerCalculationExpression_Aspect(final adruntime.IntegerCalculationExpression_Aspect integerCalculationExpression_Aspect);
Adwithoutruntime__IntegerExpressionT integerExpression_integerCalculationExpression_Aspect(final adruntime.IntegerCalculationExpression_Aspect integerCalculationExpression_Aspect);
...
Adwithoutruntime__IntegerComparisonExpressionT integerComparisonExpression_integerComparisonExpression_Aspect(final adruntime.IntegerComparisonExpression_Aspect integerComparisonExpression_Aspect);
Adwithoutruntime__ExpressionT expression_integerComparisonExpression_Aspect(final adruntime.IntegerComparisonExpression_Aspect integerComparisonExpression_Aspect);
Adwithoutruntime__IntegerExpressionT integerExpression_integerComparisonExpression_Aspect(final adruntime.IntegerComparisonExpression_Aspect integerComparisonExpression_Aspect);
...
Adwithoutruntime__ExpressionT expression_integerExpression_Aspect(final adruntime.IntegerExpression_Aspect integerExpression_Aspect);
Adwithoutruntime__IntegerExpressionT integerExpression_integerExpression_Aspect(final adruntime.IntegerExpression_Aspect integerExpression_Aspect);

Adruntime__IntegerVariable_AspectT integerVariable_Aspect(final adruntime.IntegerVariable_Aspect integerVariable_Aspect);
Adwithoutruntime__VariableT variable_integerVariable_Aspect(final adruntime.IntegerVariable_Aspect integerVariable_Aspect);
Adwithoutruntime__IntegerVariableT integerVariable_integerVariable_Aspect(final adruntime.IntegerVariable_Aspect integerVariable_Aspect);
...
Adwithoutruntime__JoinNodeT joinNode_joinNode_Aspect(final adruntime.JoinNode_Aspect joinNode_Aspect);
Adwithoutruntime__ControlNodeT controlNode_joinNode_Aspect(final adruntime.JoinNode_Aspect joinNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_joinNode_Aspect(final adruntime.JoinNode_Aspect joinNode_Aspect);
Adruntime__ControlNode_AspectT controlNode_Aspect_joinNode_Aspect(final adruntime.JoinNode_Aspect joinNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_joinNode_Aspect(final adruntime.JoinNode_Aspect joinNode_Aspect);
...
Adwithoutruntime__ControlNodeT controlNode_mergeNode_Aspect(final adruntime.MergeNode_Aspect mergeNode_Aspect);
Adwithoutruntime__NamedElementT namedElement_mergeNode_Aspect(final adruntime.MergeNode_Aspect mergeNode_Aspect);
Adwithoutruntime__MergeNodeT mergeNode_mergeNode_Aspect(final adruntime.MergeNode_Aspect mergeNode_Aspect);
Adruntime__ControlNode_AspectT controlNode_Aspect_mergeNode_Aspect(final adruntime.MergeNode_Aspect mergeNode_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_mergeNode_Aspect(final adruntime.MergeNode_Aspect mergeNode_Aspect);
...
Adwithoutruntime__ActionT action_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
Adwithoutruntime__ExecutableNodeT executableNode_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
Adwithoutruntime__NamedElementT namedElement_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
Adruntime__Action_AspectT action_Aspect_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
Adwithoutruntime__OpaqueActionT opaqueAction_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
Adwithoutruntime__ActivityNodeT activityNode_opaqueAction_Aspect(final adruntime.OpaqueAction_Aspect opaqueAction_Aspect);
...
Adwithoutruntime__VariableT variable_variable_Aspect(final adruntime.Variable_Aspect variable_Aspect);
