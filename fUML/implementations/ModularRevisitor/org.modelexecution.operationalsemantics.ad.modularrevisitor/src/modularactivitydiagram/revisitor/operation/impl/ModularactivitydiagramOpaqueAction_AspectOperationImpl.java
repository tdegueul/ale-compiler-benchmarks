...
public  class ModularactivitydiagramOpaqueAction_AspectOperationImpl implements modularactivitydiagram.revisitor.operation.ModularactivitydiagramOpaqueAction_AspectOperation
{
	
	private final adruntime.OpaqueAction_Aspect self;
	...
	public void doAction() {
		for(adwithoutruntime.Expression e: self.getExpressions()) {
			alg.$(e).execute();
		}
	}
	@Override
	...
	public void sendOffers() {
		this.modularactivitydiagramdelegate.sendOffers();
	}
	@Override
